...
def get_mail_details(service, user_id, msg_id):
    ...
    #print(temp_dict) #this prints the temp_dict which is unnecessary. 
...
def show_menu():
    ...
    print('2. Check if a mail body is spam or not manually.\n')
    print('3. Classify emails from a csv file.\n')
    print('4. Classify and delete mails from your Gmail inbox.\n')
    print('5. Exit.\n')
